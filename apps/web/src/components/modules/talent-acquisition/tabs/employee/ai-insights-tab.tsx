...
import { Loader2, Sparkles, Brain, AlertTriangle, Share2, MessageSquare, ArrowRight } from 'lucide-react';
...
const features = [
  {
    key: 'smart-referral-match',
    label: 'Smart Referral Match',
    desc: 'AI analyzes open roles and suggests people from your network who match, with fit percentages',
    endpoint: '/talent-acquisition/ai/smart-referral-match',
    icon: Share2,
  },
  {
    key: 'interview-prep',
    label: 'Interview Prep Copilot',
    desc: 'Get role-specific interview questions, evaluation rubrics, and red flag indicators',
    endpoint: '/talent-acquisition/ai/interview-prep',
    icon: MessageSquare,
  },
  {
    key: 'internal-mobility',
    label: 'Internal Mobility Match',
    desc: 'Proactively see internal openings matching your skills with gap analysis and learning paths',
    endpoint: '/talent-acquisition/ai/internal-mobility',
    icon: ArrowRight,
  },
];
