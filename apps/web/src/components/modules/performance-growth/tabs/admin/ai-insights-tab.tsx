...
import { Loader2, Sparkles, Brain, TrendingUp, AlertTriangle, BarChart3, Shield, Search } from 'lucide-react';
...
const features = [
  {
    ...
    label: 'Real-Time Performance Signals',
    desc: 'Aggregate continuous performance signals from connected tools into live indicators. Detect productivity anomalies.',
    endpoint: '/performance-growth/ai/real-time-signals',
    icon: TrendingUp,
  },
  {
    key: 'skills-gap-analysis',
    label: 'Skills Gap Analysis',
    desc: 'Org-wide current vs required skills inventory. Critical gaps by department, role, and urgency.',
    endpoint: '/performance-growth/ai/skills-gap-analysis',
    icon: Search,
  },
  {
    key: 'review-quality-scorer',
    label: 'Review Quality Scorer',
    desc: 'Score review quality across the org. Identify managers writing low-quality, generic, or copy-paste reviews.',
    endpoint: '/performance-growth/ai/review-quality-scorer',
    icon: BarChart3,
  },
  {
    key: 'promotion-equity-audit',
    label: 'Promotion Equity Audit',
    desc: 'Analyze promotion patterns for systemic bias by gender, ethnicity, location, and tenure.',
    endpoint: '/performance-growth/ai/promotion-equity-audit',
    icon: Shield,
  },
];
