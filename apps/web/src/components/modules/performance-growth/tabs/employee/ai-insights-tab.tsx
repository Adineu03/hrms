...
import { Loader2, Sparkles, Brain, FileEdit, Target, Rocket, MessageSquare, AlertTriangle } from 'lucide-react';
...
const features = [
  {
    ...
    desc: 'Generate a self-assessment draft from your goals, feedback received, and tracked achievements.',
    endpoint: '/performance-growth/ai/review-draft',
    icon: FileEdit,
  },
  {
    key: 'goal-suggestions',
    label: 'Goal Suggestions',
    desc: 'Recommend goals based on your role, team OKRs, skill gaps, and career path aspirations.',
    endpoint: '/performance-growth/ai/goal-suggestions',
    icon: Target,
  },
  {
    key: 'career-path-simulator',
    label: 'Career Path Simulator',
    desc: 'Simulate career trajectories: "What if I learn Python and get PM cert?" — see projected paths and time-to-promotion.',
    endpoint: '/performance-growth/ai/career-path-simulator',
    icon: Rocket,
  },
  {
    key: 'feedback-digest',
    label: 'Feedback Digest',
    desc: 'Summarize all received feedback into themes and actionable takeaways. Track sentiment trends over time.',
    endpoint: '/performance-growth/ai/feedback-digest',
    icon: MessageSquare,
  },
];
