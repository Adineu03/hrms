...
import { Loader2, Sparkles, Brain, AlertTriangle, Target, Bell, TrendingDown, MessageSquare } from 'lucide-react';
...
const features = [
  {
    ...
    label: 'Engagement Driver Analysis',
    desc: 'Identifies what actually drives engagement for your specific team — not generic advice',
    endpoint: '/engagement-culture/ai/engagement-drivers',
    icon: Target,
  },
  {
    key: 'smart-nudges',
    label: 'Smart Nudges',
    desc: 'Context-aware nudges: 1:1 reminders, recognition alerts, and engagement action prompts',
    endpoint: '/engagement-culture/ai/smart-nudges',
    icon: Bell,
  },
  {
    key: 'attrition-risk',
    label: 'Attrition Risk Dashboard',
    desc: 'Per-person flight risk scores with contributing factors and retention interventions',
    endpoint: '/engagement-culture/ai/attrition-risk',
    icon: TrendingDown,
  },
  {
    key: 'feedback-summary',
    label: 'Feedback Summary',
    desc: 'Synthesize anonymous team feedback into themes with emerging vs recurring issue tracking',
    endpoint: '/engagement-culture/ai/feedback-summary',
    icon: MessageSquare,
  },
];
