...
import { Loader2, Sparkles, Brain, AlertTriangle, MessageSquare, Heart, TrendingDown, DollarSign } from 'lucide-react';
...
const features = [
  {
    ...
    desc: 'NLP analysis of survey responses for themes, sentiment, and department-level comparisons',
    endpoint: '/engagement-culture/ai/sentiment-analysis',
    icon: MessageSquare,
  },
  {
    key: 'culture-health-score',
    label: 'Culture Health Score',
    desc: 'Composite AI metric combining surveys, attrition, recognition, and feedback data over time',
    endpoint: '/engagement-culture/ai/culture-health-score',
    icon: Heart,
  },
  {
    key: 'attrition-model',
    label: 'Org-Wide Attrition Model',
    desc: 'Predict who will leave, when, and why — with department risk heat maps',
    endpoint: '/engagement-culture/ai/attrition-model',
    icon: TrendingDown,
  },
  {
    key: 'engagement-roi',
    label: 'Engagement ROI Calculator',
    desc: 'Model financial impact of engagement initiatives and prioritize highest-ROI programs',
    endpoint: '/engagement-culture/ai/engagement-roi',
    icon: DollarSign,
  },
];
