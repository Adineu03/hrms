...
import { Loader2, Sparkles, Brain, AlertTriangle, Flower2, Mic, Heart } from 'lucide-react';
...
const features = [
  {
    key: 'personalized-wellness',
    label: 'Personalized Wellness',
    desc: 'Wellness suggestions based on your work patterns — privacy-safe, no personal data used',
    endpoint: '/engagement-culture/ai/personalized-wellness',
    icon: Flower2,
  },
  {
    key: 'anonymous-voice',
    label: 'Anonymous Voice Insights',
    desc: 'See what themes are trending across the company from aggregated anonymous feedback',
    endpoint: '/engagement-culture/ai/anonymous-voice',
    icon: Mic,
  },
  {
    key: 'culture-match-pulse',
    label: 'Culture Match Pulse',
    desc: 'Check how well your daily experiences align with stated company values (private to you)',
    endpoint: '/engagement-culture/ai/culture-match-pulse',
    icon: Heart,
  },
];
