...
import { Loader2, Sparkles, Brain, AlertTriangle, TrendingDown, MessageSquare, Activity } from 'lucide-react';
...
const features = [
  {
    ...
    desc: 'Analyze onboarding completion times, identify bottlenecks, and compare across departments',
    endpoint: '/onboarding-offboarding/ai/process-optimization',
    icon: Activity,
  },
  {
    key: 'exit-interview-analyzer',
    label: 'Exit Interview Analyzer',
    desc: 'NLP analysis of exit interview transcripts for themes, sentiment, and trend reports',
    endpoint: '/onboarding-offboarding/ai/exit-interview-analyzer',
    icon: MessageSquare,
  },
  {
    key: 'attrition-model',
    label: 'Predictive Attrition Model',
    desc: 'Org-wide flight risk scores with early warning dashboard and retention ROI analysis',
    endpoint: '/onboarding-offboarding/ai/attrition-model',
    icon: TrendingDown,
  },
];
