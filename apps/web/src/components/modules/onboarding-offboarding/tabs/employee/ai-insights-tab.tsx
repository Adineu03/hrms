...
import { Loader2, Sparkles, Brain, AlertTriangle, Route, MessageCircle, Activity } from 'lucide-react';
...
const features = [
  {
    key: 'personalized-onboarding',
    label: 'Personalized Onboarding',
    desc: 'AI adapts your onboarding path by role, seniority, and location with tailored content',
    endpoint: '/onboarding-offboarding/ai/personalized-onboarding',
    icon: Route,
  },
  {
    key: 'onboarding-buddy',
    label: 'AI Onboarding Buddy',
    desc: '24/7 chatbot answers your questions about company policies, tools, and processes',
    endpoint: '/onboarding-offboarding/ai/onboarding-buddy',
    icon: MessageCircle,
  },
  {
    key: 'sentiment-tracking',
    label: 'Sentiment Tracking',
    desc: 'Monitor your first 90 days experience and spot early engagement signals',
    endpoint: '/onboarding-offboarding/ai/sentiment-tracking',
    icon: Activity,
  },
];
