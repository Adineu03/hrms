...
import { Loader2, Sparkles, Brain, AlertTriangle, AlertCircle, BookOpen, TrendingDown } from 'lucide-react';
...
const features = [
  {
    key: 'onboarding-risk-alert',
    label: 'Onboarding Risk Alerts',
    desc: 'Flags new hires showing disengagement with risk scoring and recommended actions',
    endpoint: '/onboarding-offboarding/ai/onboarding-risk-alert',
    icon: AlertCircle,
  },
  {
    key: 'smart-knowledge-transfer',
    label: 'Smart Knowledge Transfer',
    desc: 'Auto-generate handover documents, identify critical knowledge areas, and suggest recipients',
    endpoint: '/onboarding-offboarding/ai/smart-knowledge-transfer',
    icon: BookOpen,
  },
  {
    key: 'exit-prediction',
    label: 'Exit Prediction',
    desc: 'Identify flight risk signals before formal resignation with retention intervention suggestions',
    endpoint: '/onboarding-offboarding/ai/exit-prediction',
    icon: TrendingDown,
  },
];
