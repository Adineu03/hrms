...
import { Loader2, Sparkles, Brain, AlertTriangle, MessageSquare, SearchCode, Lightbulb } from 'lucide-react';
...
const features = [
  {
    key: 'universal-assistant',
    label: 'Universal AI Assistant',
    desc: "Single conversational interface: 'Apply for leave Friday', 'Show my payslip', 'Who's my skip-level?'",
    endpoint: '/platform-experience/ai/universal-assistant',
    icon: MessageSquare,
  },
  {
    key: 'intelligent-search',
    label: 'Intelligent Search',
    desc: "Semantic search — 'maternity policy in UAE' finds the right doc even if wording differs",
    endpoint: '/platform-experience/ai/intelligent-search',
    icon: SearchCode,
  },
  {
    key: 'proactive-suggestions',
    label: 'Proactive Suggestions',
    desc: "Context-aware prompts: 'Your certification expires in 30 days', 'Timesheet due tomorrow — auto-fill from calendar?'",
    endpoint: '/platform-experience/ai/proactive-suggestions',
    icon: Lightbulb,
  },
];
