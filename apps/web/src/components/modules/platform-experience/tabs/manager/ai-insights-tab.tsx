...
import { Loader2, Sparkles, Brain, AlertTriangle, Crosshair, BarChart3 } from 'lucide-react';
...
const features = [
  {
    ...
    desc: 'Surfaces what needs attention today — prioritized by urgency and impact based on your patterns',
    endpoint: '/platform-experience/ai/manager-copilot',
    icon: Crosshair,
  },
  {
    key: 'nl-reports',
    label: 'Natural Language Reports',
    desc: 'Ask questions in plain English and get instant data tables and charts without building reports',
    endpoint: '/platform-experience/ai/nl-reports',
    icon: BarChart3,
  },
];
