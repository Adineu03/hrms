...
import { Loader2, Sparkles, Brain, AlertTriangle, TrendingUp, Heart, Bell } from 'lucide-react';
...
const features = [
  {
    key: 'smart-raise',
    label: 'Smart Raise Recommender',
    desc: 'Suggests raise amounts optimized for retention, equity, budget, and market per person',
    endpoint: '/compensation-rewards/ai/smart-raise',
    icon: TrendingUp,
  },
  {
    key: 'retention-comp-model',
    label: 'Retention x Comp Model',
    desc: 'Model the impact of different comp changes on flight risk with diminishing returns analysis',
    endpoint: '/compensation-rewards/ai/retention-comp-model',
    icon: Heart,
  },
  {
    key: 'recognition-nudges',
    label: 'Recognition Nudges',
    desc: 'Alerts when team members deserve recognition with equity analysis across the team',
    endpoint: '/compensation-rewards/ai/recognition-nudges',
    icon: Bell,
  },
];
