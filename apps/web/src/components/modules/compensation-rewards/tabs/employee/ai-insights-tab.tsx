...
import { Loader2, Sparkles, Brain, AlertTriangle, MessageCircle, Calculator, Gift } from 'lucide-react';
...
const features = [
  {
    key: 'comp-clarity',
    label: 'Comp Clarity Bot',
    desc: 'Instant personalized answers: bonus calculation, equity vesting, and market comparison',
    endpoint: '/compensation-rewards/ai/comp-clarity',
    icon: MessageCircle,
  },
  {
    key: 'tax-smart-insights',
    label: 'Tax-Smart Insights',
    desc: 'Suggest optimal equity exercise timing and model tax implications of different strategies',
    endpoint: '/compensation-rewards/ai/tax-smart-insights',
    icon: Calculator,
  },
  {
    key: 'rewards-recommender',
    label: 'Rewards Recommender',
    desc: 'Maximize your benefits and perks based on your usage patterns and life stage',
    endpoint: '/compensation-rewards/ai/rewards-recommender',
    icon: Gift,
  },
];
