...
import { Loader2, Sparkles, Brain, AlertTriangle, BookMarked, GraduationCap, Cpu } from 'lucide-react';
...
const features = [
  {
    key: 'learning-curator',
    label: 'AI Learning Curator',
    desc: 'Recommends courses based on skill gaps, career goals, learning style, and high-performer patterns',
    endpoint: '/learning-development/ai/learning-curator',
    icon: BookMarked,
  },
  {
    key: 'ai-tutor',
    label: 'AI Tutor',
    desc: 'Ask questions about course content and get instant explanations with practice quizzes',
    endpoint: '/learning-development/ai/ai-tutor',
    icon: GraduationCap,
  },
  {
    key: 'skill-inference',
    label: 'Skill Inference Engine',
    desc: 'Detects skills from your projects, commits, and documents — adds to profile with your approval',
    endpoint: '/learning-development/ai/skill-inference',
    icon: Cpu,
  },
];
