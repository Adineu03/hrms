...
import { Loader2, Sparkles, Brain, AlertTriangle, FileEdit, GitBranch, TrendingUp } from 'lucide-react';
...
const features = [
  {
    ...
    desc: 'Create micro-courses from internal SOPs, policies, and documents with auto-generated quizzes',
    endpoint: '/learning-development/ai/content-generator',
    icon: FileEdit,
  },
  {
    key: 'skill-taxonomy',
    label: 'Skill Taxonomy Engine',
    desc: 'Build and maintain org-wide skill taxonomy from JDs, learning data, and market trends',
    endpoint: '/learning-development/ai/skill-taxonomy',
    icon: GitBranch,
  },
  {
    key: 'learning-impact',
    label: 'Learning Impact Modeler',
    desc: 'Model ROI of proposed learning investments with scenario planning for build vs hire decisions',
    endpoint: '/learning-development/ai/learning-impact',
    icon: TrendingUp,
  },
];
