...
import { Loader2, Sparkles, Brain, AlertTriangle, Map, TrendingUp, User } from 'lucide-react';
...
const features = [
  {
    key: 'team-skill-map',
    label: 'Team Skill Map',
    desc: 'AI-generated visual of team capabilities, gaps, and single-person skill dependencies',
    endpoint: '/learning-development/ai/team-skill-map',
    icon: Map,
  },
  {
    key: 'learning-roi',
    label: 'Learning ROI Insights',
    desc: 'Connect training completions to performance improvements with cost-effectiveness rankings',
    endpoint: '/learning-development/ai/learning-roi',
    icon: TrendingUp,
  },
  {
    key: 'development-copilot',
    label: 'Development Copilot',
    desc: 'Auto-generate personalized development plans per team member based on gaps and patterns',
    endpoint: '/learning-development/ai/development-copilot',
    icon: User,
  },
];
